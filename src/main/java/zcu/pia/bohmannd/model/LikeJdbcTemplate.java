...
public class LikeJdbcTemplate implements LikeDAO {
	...
	public void deleteLike(Integer id) {
		String SQL = "delete from bohmannd_like where id=?";
		jdbcTemplateObject.update(SQL, id);		
	}

	@Override
	public int getLikesCount(int status_id) {
		String SQL = "select count(*) from bohmannd_like where status_id=" + status_id;
